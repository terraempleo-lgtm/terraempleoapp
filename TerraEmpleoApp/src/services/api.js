...
export const cuadernoAPI = {
  ...
  // Foto de planilla sin recortar puede pesar varios MB — el timeout
  // default (30s) no alcanza para subirla + que Bedrock la procese.
  leerPlanilla: (imagenBase64) => api.post('/cuaderno/jornadas/leer-planilla', { imagen: imagenBase64 }, { timeout: 90000 }),
  ...
  crearEntrada: (asistenciaId, data) => api.post(`/cuaderno/asistencias/${asistenciaId}/entradas`, data),
  actualizarEntrada: (entradaId, data) => api.put(`/cuaderno/entradas/${entradaId}`, data),
  eliminarEntrada: (entradaId) => api.delete(`/cuaderno/entradas/${entradaId}`),
