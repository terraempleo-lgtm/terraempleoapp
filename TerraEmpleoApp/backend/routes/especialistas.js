...
const { listarEspecialistas, getPerfilEspecialista, contactarEspecialista, contactarDesdeServicio, getContactoEstado, misSolicitudesContacto, responderSolicitudContacto } = require('../controllers/especialistaController');
...
router.post('/:id/contactar-directo', authMiddleware, empleadorMiddleware, contactarDesdeServicio);
