...
const styles = StyleSheet.create({
  ...
  celda: { width: 90, textAlign: 'right', fontSize: 12, paddingHorizontal: 6, paddingVertical: 6, backgroundColor: COLORS.lineLight, borderRadius: 6, marginRight: 2 },
  ...
  nuevoConceptoInput: { flex: 1, borderWidth: 1, borderColor: COLORS.line, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, fontSize: 13, backgroundColor: '#fff' },
