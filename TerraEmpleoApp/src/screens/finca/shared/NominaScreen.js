...
const styles = StyleSheet.create({
  ...
  modalTextarea: { borderWidth: 1, borderColor: COLORS.line, borderRadius: 10, padding: 10, minHeight: 80, textAlignVertical: 'top', fontSize: 13, color: COLORS.ink900 },
  ...
  input: { borderWidth: 1, borderColor: COLORS.line, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, color: COLORS.ink900 },
